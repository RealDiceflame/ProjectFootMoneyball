...
The homepage opens with “Be an Outlier. Know your Baseline.” and a weekly reported-score strip. Scores refresh independently of rankings, about every 15 minutes near games and every six hours otherwise. They are not a live game-clock feed. See [scoreboard sources, scheduling and safeguards](documentation/scoreboard.md).
