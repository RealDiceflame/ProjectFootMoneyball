...
test("all site pages use the same cache-busted shared navigation and explicit prototype labels", () => {
  for (const page of ["index", "rankings", "projection", "survivor", "special-teams", "odds", "league", "fantasy"]) {
    const html = readFileSync(new URL(`../docs/${page}.html`, import.meta.url), "utf8");
    assert.match(html, /site-nav.js\?v=20260913-compact1/); assert.match(html, /site-nav.css\?v=20260913-home1/);
  }
